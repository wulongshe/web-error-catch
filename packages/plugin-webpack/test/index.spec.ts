...
import { convertSourceMaps } from '../src';
...
test('convertSourceMaps', async () => {
  ...
  expect(sourceMaps).toEqual({
    'main.b5517e4f0908ffb38333.js.map': `{"version":3,"file":"main.b5517e4f0908ffb38333.js","mappings":"mBAAO,IAAsBA,ECC7BC,SAASC,cAAc,QAAQC,UAAY,iHDDdH,ECEhBC,SAASC,cAAc,aDDxBC,UAAY,gBACpBH,EAAQI,iBAAiB,SAAS,WAC9B,MAAM,IAAIC,MAAM,gBACpB,G","sources":["webpack://react-app/./src/counter.ts","webpack://react-app/./src/index.ts"],"sourcesContent":["export function setupCounter(element) {\\n    element.innerHTML = \\"trigger error\\";\\n    element.addEventListener(\'click\', function () {\\n        throw new Error(\'trigger error\');\\n    });\\n}\\n","import { setupCounter } from \'./counter\';\\ndocument.querySelector(\'#app\').innerHTML = \\"\\\\n  <div>\\\\n    <div class=\\\\\\"card\\\\\\">\\\\n      <button id=\\\\\\"counter\\\\\\" type=\\\\\\"button\\\\\\"></button>\\\\n    </div>\\\\n  </div>\\\\n\\";\\nsetupCounter(document.querySelector(\'#counter\'));\\n"],"names":["element","document","querySelector","innerHTML","addEventListener","Error"],"sourceRoot":""}`,
  });
});
